"""Offline MIPROv2: compile on GT-bearing train/development, freeze, then evaluate."""
...
from optimizer import compile_program, learned_context
...
def execute(parent, stage, cell, native, dev=False, probe_n=6):
    ...
    try:
        ...
        if dev:
            ...
            train, development = subset(train, 'r6-train'), subset(development, 'r6-dev')
        ...
        if dev: order, records = probe_sources(native, data, probe_n, 'r6-probe')
        else:
