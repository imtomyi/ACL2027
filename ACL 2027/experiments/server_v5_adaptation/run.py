...
def execute(parent, stage, cell, native, upstream, dev=False):
    ...
    def status(kind, error=None):
        ...
        value = dict(condition_id=cell['id'], dataset=cell['dataset'], method=cell['method'],
                     ...
                     updated=len(updates), total=2 if dev else 100, judged=0,
    ...
    try:
        ...
        for phase in phases:
            ...
            if dev:
                # Probe the shortest and longest actual development sources, never test inputs.
