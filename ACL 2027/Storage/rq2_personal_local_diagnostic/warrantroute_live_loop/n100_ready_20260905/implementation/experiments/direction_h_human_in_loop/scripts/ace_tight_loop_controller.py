...
def validate_model_family_separation(state: dict[str, Any]) -> None:
    """Enforce independent compact-model families in the semantic loop."""
...
def decide_next(state: dict[str, Any]) -> dict[str, Any]:
    ...
    validate_model_family_separation(state)
