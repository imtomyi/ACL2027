...
Date: 2026-09-10 KST. Status: launched at 06:26:16 KST after passed preflight;
see the [launch record](warrantroute_flaw_detection_8h_launch_record.md). User request: run more data under the
