# Table 3 Working Interim Snapshot

Status: internal working result only; not manuscript eligible.

- Sample: balanced N=100 per dataset.
- Completed and scored: Dreaddit, GoEmotion, CaChe.
- Pending: ParlaMint-GB.
- WarrantRoute implementation: working WarrantGate v0.
- Intervals: Wilson 95% confidence intervals.
- Source snapshot: `table3_resilient_n100_20260902_table3_combined.md`.
- GoEmotion currently contains one `schema_warning`; the strict finalizer will repair and rescore it before publishing the final 48-row table.
...
| ParlaMint-GB | Generalist | Qwen3 8B | pending | pending |
| ParlaMint-GB | Generalist | Llama 3.1 8B | pending | pending |
| ParlaMint-GB | Generalist | Gemma 3 4B | pending | pending |
| ParlaMint-GB | Fixed role | Qwen3 8B | pending | pending |
| ParlaMint-GB | Fixed role | Llama 3.1 8B | pending | pending |
| ParlaMint-GB | Fixed role | Gemma 3 4B | pending | pending |
| ParlaMint-GB | All roles | Qwen3 8B | pending | pending |
| ParlaMint-GB | All roles | Llama 3.1 8B | pending | pending |
| ParlaMint-GB | All roles | Gemma 3 4B | pending | pending |
| ParlaMint-GB | WarrantRoute | Qwen3 8B | pending | pending |
| ParlaMint-GB | WarrantRoute | Llama 3.1 8B | pending | pending |
| ParlaMint-GB | WarrantRoute | Gemma 3 4B | pending | pending |
